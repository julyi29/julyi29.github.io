...
<html lang="de">
  <head>
    ...
    <meta
      name="description"
      content="Hier ist der Ort wo ich meine persönliche Reise zur Front-End Entwicklung und Design-Stduies veröffentlichen werde."
    />
    <!-- Style-Sheets und Fonts -->
    <link
      rel="stylesheet"
  ...
  <body>
    <div class="jumbotron-jumbotron-fluid">
      <div class="container">
        <h1 class="display-4">Hello World, (ʘ‿ʘ)╯</h1>
        <p class="lead">
          This is my simple portfolio. Here you can follow my first steps into
          front-end-development und iOS developtment.
        </p>
      </div>
    </div>
    <div class="ju-inital">
      <svg
        ...
        "
      >
        <g transform="matrix(1,0,0,1,-31.6735,-57.9578)">
          <g id="Initial" transform="matrix(0.7939,0,0,0.7939,47.8222,60.4343)">
            <path
